...
/**
 * Rewrite of the EntityManager to use a read only Unit Of Work.
 * A readonly Unit Of Work will load properly data as well as do
 * lazy loading but won't keep any reference of objects, avoiding
 * manual memory management and leaks.
 *
 * @author    Benoit Jacquemont <benoit@akeneo.com>
 * @copyright 2015 Akeneo SAS (http://www.akeneo.com)
 * @license   http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */
class ReadOnlyEntityManager implements EntityManagerInterface
{
    /**
    ...
    /**
     * The official entitymanager service must be provided here
     * to get the connection, configuration and eventmanager
     */
    protected function __construct(EntityManager $entityManager)
    {
        ...
        $this->unitOfWork        = new ReadOnlyUnitOfWork($this);
    ...
    {
        throw new Exception("Read only entity manager");
    }
